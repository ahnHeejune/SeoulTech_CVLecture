...
2. Python, Numpy, MatplotLib, and OpenCV
3. Image Processing 
4. Edge and Region
5. Features  
6. CV applciation example (interim)
7. NN
8. CNN
9. Recogonition 
10. Video 
11. (3D)    - not planed to cover in the lecture  
12. (Geneneration)  - not planed to  cover in the lecture

## History 

- 2026.04.20: Part-1: Classical Computer Vison  
